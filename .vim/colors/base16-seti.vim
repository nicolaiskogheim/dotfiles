" Base16 Seti (https://github.com/chriskempson/base16)
" Scheme: Jesse Weed (https://github.com/jesseweed)
...
if !has('gui_running')
  if exists("g:base16_shell_path")
    execute "silent !/bin/sh ".g:base16_shell_path."/base16-seti.".&background.".sh"
  endif
endif
...
call <sid>hi("PMenu",         s:gui00, s:gui0C, s:cterm00, s:cterm0C, "none")
...
" Diff highlighting
call <sid>hi("DiffAdd",      s:gui0B, s:gui01,  s:cterm01, s:cterm0B, "")
call <sid>hi("DiffChange",   s:gui03, s:gui01,  s:cterm03, s:cterm01, "")
call <sid>hi("DiffDelete",   s:gui08, s:gui01,  s:cterm08, s:cterm01, "")
call <sid>hi("DiffText",     s:gui0D, s:gui01,  s:cterm01, s:cterm0A, "")
